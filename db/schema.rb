...
ActiveRecord::Schema.define(:version => 20131211110045) do
  ...
  add_index "galleries_images", ["image_id", "gallery_id"], :name => "index_galleries_images_on_image_id_and_gallery_id"
